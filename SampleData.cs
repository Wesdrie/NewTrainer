    ...
    internal class SampleData
    {
        ...
        public static TreeNode<CallAreas> LoadDatatFile()
        {
            ...
            foreach (string line in File.ReadLines(@"C:\TestData.txt"))
            {
                ...
                {
                    root.AddChild(new CallAreas(values[2], values[3]));
                }
                if (values[0].Contains("1"))
                {
                    ...
                    root.Children[valueOne].AddChild(new CallAreas(values[2], values[3]));
                }
                if (values[0].Contains("2"))
                {
                    int valueThree = Int16.Parse(values[1]);
                    int valueFour = Int16.Parse(values[2]);
                    ...
                    root.Children[valueOne].Children[valueTwo].AddChild(new CallAreas(values[2], values[3]));
